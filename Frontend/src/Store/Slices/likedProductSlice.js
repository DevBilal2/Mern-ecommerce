...
export const fetchLikedProducts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get("https://mern-ecommerce-mvvv.onrender.com/api/likes", { withCredentials: true });
...
export const unlikeProduct = createAsyncThunk(
  ...
  async (productId, { rejectWithValue }) => {
    try {
      await axios.delete(`https://mern-ecommerce-mvvv.onrender.com/api/likes/${productId}`, { withCredentials: true });
